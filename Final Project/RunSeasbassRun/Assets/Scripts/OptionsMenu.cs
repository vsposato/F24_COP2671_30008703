...
public class OptionsMenu : MonoBehaviour
{
    ...
    {
        GetAndRestoreMixerValue("MasterVolume");
        GetAndRestoreMixerValue("MusicVolume");
        GetAndRestoreMixerValue("SfxVolume");
    ...
    public void SetMasterVolume()
    {
        ...
        SetAndSaveMixerValue("MasterVolume", masterVolumeSlider.value);
    }
    ...
    public void SetMusicVolume()
    {
        ...
        SetAndSaveMixerValue("MusicVolume", musicVolumeSlider.value);
    }
    ...
    public void SetSfxVolume()
    {
        ...
        SetAndSaveMixerValue("SfxVolume", sfxVolumeSlider.value);
    }
